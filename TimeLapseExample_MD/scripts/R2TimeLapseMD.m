...
for i = 1:length(files)
    ...
    if i == 1
        ...
        [dataStart, gmean] = preprocLipp_ErrMod(fLoc, minVal, errRecip(1)); % preprocess raw data 
        writeR2in(gmean, 1, numel, reg_modeSTART, alpha_s, alpha_aniso, num_electrodes, a_wgt, b_wgt) % write R2.in
    else
        startModel = 'start_res.dat';
        [data, gmean] = preprocLipp_ErrMod(fLoc, minVal, errRecip(i));
